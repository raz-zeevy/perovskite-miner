...
gpt_preview_prompt = 'Your task is to extract specific data from an academic paper focused on solar cells and perovskite \
materials. You will receive the full text of the paper along with questions and a format for the answers. Analyze the\
